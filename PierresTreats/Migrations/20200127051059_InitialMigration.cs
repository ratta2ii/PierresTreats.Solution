    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlavorTreatList", x => x.FlavorTreatId);
                    table.ForeignKey(
                        name: "FK_FlavorTreatList_Flavors_FlavorId",
                        column: x => x.FlavorId,
                        principalTable: "Flavors",
                        principalColumn: "FlavorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlavorTreatList_Treats_TreatId",
                        column: x => x.TreatId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlavorTreatList_FlavorId",
                table: "FlavorTreatList",
                column: "FlavorId");

            migrationBuilder.CreateIndex(
                name: "IX_FlavorTreatList_TreatId",
                table: "FlavorTreatList",
                column: "TreatId");
